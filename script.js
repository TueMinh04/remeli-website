...
const translations = {
  vi: {
    ...
    faq6A: 'Phương thức thanh toán được hiển thị trong app tại thời điểm đặt giữ phần. Tùy giai đoạn vận hành, Remeli có thể hỗ trợ thanh toán tại cửa hàng hoặc phương thức thanh toán điện tử phù hợp.',
    faq7Q: 'Tôi có thể yêu cầu xóa thông tin cá nhân không?',
    faq7A: 'Có. Bạn có thể gửi yêu cầu liên quan đến thông tin cá nhân qua form liên hệ hoặc email privacy@remeli.vn. Remeli sẽ xử lý theo chính sách quyền riêng tư và quy định pháp luật áp dụng.',
    ...
    faq10A: 'Bạn có thể gửi thông tin qua form liên hệ và chọn chủ đề <strong>Truyền thông/Cộng đồng</strong>, hoặc gửi email tới <a href="mailto:remeli.vn@gmail.com">remeli.vn@gmail.com</a>.',
